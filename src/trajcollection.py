...
class Trajcollection():
    ...
    def __init__(self,globalIDs = None, IDmap = None, frames = None):
        """
        ...
        Parameters: globalIDs: array_like
                         globalIDs :: numpy.ndarray(np.int32)
                    IDmap: dict
                        A map from globalIDs to localIDs (array indices)
        ...
        self.frames = frames # :: numpy.ndarray, type is generated by the trajectory reader (unknown to me).
        ...
        if frames is None:
            ...
            self.shape = frames.shape # :: Tuple of Integers.
            self.number_frames = frames.shape[0] # :: Integer
            self.number_atoms  = frames.shape[1] # :: Integer
